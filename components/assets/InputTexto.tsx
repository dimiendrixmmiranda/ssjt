...
export default function InputTexto({ label, id, nome, valor, icone, placeholder, estiloPersonalizado, setValor }: InputTextoProps) {
    return (
        <div className={`flex flex-col w-full 2xl:gap-1 ${estiloPersonalizado}`}>
