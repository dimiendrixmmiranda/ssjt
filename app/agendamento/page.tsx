...
import { FaMapPin, FaPlus } from "react-icons/fa6"
...
import { Menu, menusDashboardAgendamento } from "@/lib/menusDashboardAgendamento"
...
export default function Page() {
    ...
    const gerarBotaoMenu = (menu: Menu) => {
        return (
            <li key={menu.titulo}>
                <Link href={menu.url}
        ...
        <div className="p-4 flex flex-col gap-4 row-span-2">
            <div className="flex items-center gap-6">
                <div className="flex items-center my-auto gap-2 text-verde-escuro">
                    ...
                    <h3 className="text-3xl font-bold">Painel do {usuario?.perfil}</h3>
                </div>
            ...
            <div className="relative flex items-center gap-2 p-4 rounded-lg shadow-[0px_0px_2px_1px_var(--verde-escuro)] overflow-hidden">
                ...
                <div className="relative w-16 h-20">
                    <Image alt="Brasao SSJT" src={'/logo/brasao-sistema-de-saude.png'} fill className="object-contain" />
                </div>
                <div>
                    <h4 className="text-2xl">Bem Vindo (a), <b className="text-verde uppercase">{usuario?.nome}</b></h4>
                    <span>Gerencie todos os recursos do sistema de saúde.</span>
                </div>
            </div>
            <div className="flex flex-col gap-4 3xl:grid 4xl:grid-cols-2">
                ...
                <div className="flex flex-col bg-white rounded-xl shadow-[0px_0px_2px_1px_var(--verde-escuro)] overflow-hidden col-span-3">
                    ...
                    <div className="px-4">
                        <ul className="flex gap-4 py-2">
                            {menusDashboardAgendamento.map((menu) =>
                                gerarBotaoMenu(menu)
                            )}
                        </ul>
                    </div>
