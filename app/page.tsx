...
import InputSenha from "@/components/assets/inputs/InputSenha";
...
export default function Home() {
	...
	const gerarImagemDeFundo = (posicao: string) => {
		return (
			<div className={`fixed top-1/2 ${posicao} opacity-40 -translate-y-1/2`}>
				<div className="relative w-[500px] h-[650px]">
					<Image
						alt=""
						src="/logo/brasao-sistema-de-saude.png"
						fill
	...
	return (
		<div className="w-screen h-screen overflow-hidden flex flex-col font-arimo">
			<header className="w-full p-2 flex items-center border-b-4 border-verde-escuro z-30">
				...
				<div className="relative w-[200px] h-[60px]">
					<Image
						...
						src="/logo/sistema-de-saude-verde.png"
						fill
						className="object-contain"
					/>
				</div>
			...
			<main className="relative flex-1 overflow-hidden">
				...
				/>
				{gerarImagemDeFundo('-left-[200px]')}
				{gerarImagemDeFundo('-right-[200px]')}
				<div className="absolute inset-0 flex justify-center items-center z-[999] 2xl:mt-6">
					...
					>
						<div className="relative w-full h-[240px]">
							<Image
								alt="Logo do SSJT"
								src="/logo/logo-sistema-de-saude.png"
								fill
								className="object-contain"
							/>
						</div>
			...
			<footer className="w-full font-oswald bg-verde-escuro text-white grid grid-cols-[auto_1fr_auto] p-1 px-2 border-t-4 border-verde-escuro">
				<div className="flex items-center justify-center">
					<div className="relative w-8 h-10">
						<Image alt="logo do sistema" src={'/logo/brasao-sistema-de-saude.png'} fill className="object-contain" />
					</div>
